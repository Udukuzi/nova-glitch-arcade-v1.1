    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          {/* Social Media Icons with Glitch */}
          <motion.div
          ...
          >
            <a
              href="https://twitter.com/NovaArcadeGlitch"
              target="_blank"
              ...
              style={{
                ...
                filter: `drop-shadow(${glitchOffset}px 0 0 rgba(96, 165, 250, 0.5))`
              }}
              onMouseEnter={(e) => {
            ...
            <a
              href="https://dexscreener.com/solana/Gd5oUtNMQ5rHG9io17Rv2XdrZ3LGQHQcCqQgD8sSw3GB"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                textDecoration: 'none',
                transition: 'all 0.3s ease',
                display: 'inline-block',
                filter: `drop-shadow(${glitchOffset}px 0 0 rgba(138, 240, 255, 0.5))`
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = 'scale(1.2) translateY(-2px)'
                e.currentTarget.style.filter = 'drop-shadow(0 0 15px rgba(138, 240, 255, 0.9))'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'scale(1) translateY(0)'
                e.currentTarget.style.filter = `drop-shadow(${glitchOffset}px 0 0 rgba(138, 240, 255, 0.5))`
              }}
            >
              <img 
                ...
                onError={(e) => {
                  ...
                  if (parent && !parent.querySelector('.fallback-dex')) {
                    ...
                    fallback.style.cssText = 'font-size: 28px; color: #8af0ff; font-weight: bold;'
                    parent.appendChild(fallback)
                  }
                }}
                style={{
            ...
            <a
              ...
              style={{
                ...
                transition: 'all 0.3s ease',
                display: 'inline-block',
                filter: `drop-shadow(${glitchOffset}px 0 0 rgba(0, 136, 204, 0.5))`
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = 'scale(1.2) translateY(-2px)'
                e.currentTarget.style.filter = 'drop-shadow(0 0 15px rgba(0, 136, 204, 0.9))'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'scale(1) translateY(0)'
                e.currentTarget.style.filter = `drop-shadow(${glitchOffset}px 0 0 rgba(0, 136, 204, 0.5))`
              }}
            >
              <img 
                ...
                onError={(e) => {
                  ...
                  if (parent && !parent.querySelector('.fallback-telegram')) {
                    ...
                    fallback.style.cssText = 'font-size: 28px; color: #0088cc;'
                    parent.appendChild(fallback)
                  }
                }}
                style={{
