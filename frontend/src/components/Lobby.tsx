...
import TokenGateOverlay from './TokenGateOverlay'
...
const games = [
  ...
  { id: 'coming2', name: 'Game 8', sub: 'Coming soon', icon: '🎯', color: '#ff4081' },
  { id: 'coming3', name: 'Game 9', sub: 'Coming soon', icon: '🎲', color: '#00e5ff' },
]
