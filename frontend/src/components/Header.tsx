...
interface HeaderProps {
  ...
  onShowSettings?: () => void;
  onShowSwap?: () => void;
  onShowGlobalLeaderboard?: () => void;
  onShowAchievements?: () => void;
  onShowReferralProgram?: () => void;
  onShowTournaments?: () => void;
  onShowProfile?: () => void;
  onShowPaymentDashboard?: () => void;
...
const Header = ({
  ...
  onShowAchievements,
  onShowReferralProgram,
  onShowTournaments,
  onShowProfile,
  onShowPaymentDashboard,
            ...
            <div style={{
              ...
              <div>
                ...
                <nav style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  {[
                    { icon: '👤', label: 'My Profile', desc: 'Stats & history', action: onShowProfile },
                    { icon: '💰', label: 'Payment Dashboard', desc: 'Earnings & payouts', action: onShowPaymentDashboard },
                    { icon: '🛡️', label: 'Admin Dashboard', desc: 'AI monitoring & bans', action: onShowAdminDashboard },
                    { icon: '👥', label: 'Social Hub', desc: 'Friends & challenges', action: onShowSocialHub },
                    { icon: '🎮', label: 'Games Lobby', desc: 'Browse & play', action: onScrollToGames },
                    { icon: '🏆', label: 'Tournaments', desc: 'Compete for prizes', action: onShowTournaments },
                    { icon: '📈', label: 'Global Leaderboard', desc: 'All-time rankings', action: onShowGlobalLeaderboard },
                    { icon: '📊', label: 'Game Leaderboard', desc: 'Per-game scores', action: onShowLeaderboard },
                    { icon: '🎖️', label: 'Achievements', desc: 'Unlock rewards', action: onShowAchievements },
                    { icon: '💸', label: 'Refer & Earn', desc: 'Earn 10% forever', action: onShowReferralProgram },
