...
import ComingSoon3 from './games/ComingSoon3'
...
export default function GameShell({ gameId, onBack }: GameShellProps) {
  ...
  const gameInfo: Record<string, { name: string; comp: React.ReactNode }> = {
    ...
    coming2: { name: 'Game 8', comp: <ComingSoon2 key={gameKey} onGameOver={handleGameOver} /> },
    coming3: { name: 'Game 9', comp: <ComingSoon3 key={gameKey} onGameOver={handleGameOver} /> }
  }
